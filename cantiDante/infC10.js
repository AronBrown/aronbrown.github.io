...
$(document).ready(function(){
	$("#buttoninfC10").click(function(){
		numero=Math.floor(Math.random()*infC10.length)
		randnopre = infC10[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = infC10[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = infC10[numero+1];
