...
$(document).ready(function(){
	$("#buttonpurgC11").click(function(){
		numero=Math.floor(Math.random()*purgC11.length)
		randnopre = purgC11[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC11[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC11[numero+1];
