...
$(document).ready(function(){
	$("#buttoninfC28").click(function(){
		numero=Math.floor(Math.random()*infC28.length)
		randnopre = infC28[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = infC28[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = infC28[numero+1];
		if (typeof(randnopost)=="undefined") {
			randnopost="..."
		}
		$('#zonaDinamicaPost').text(randnopost);
		console.log("Inferno 28");
	});
});
