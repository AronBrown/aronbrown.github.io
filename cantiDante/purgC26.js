...
$(document).ready(function(){
	$("#buttonpurgC26").click(function(){
		numero=Math.floor(Math.random()*purgC26.length)
		randnopre = purgC26[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC26[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC26[numero+1];
