...
$(document).ready(function(){
	$("#buttonpurgC2").click(function(){
		numero=Math.floor(Math.random()*purgC2.length)
		randnopre = purgC2[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC2[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC2[numero+1];
		if (typeof(randnopost)=="undefined") {
			randnopost="..."
		}
		$('#zonaDinamicaPost').text(randnopost);
		console.log("Purgatorio 2");
	});
});
