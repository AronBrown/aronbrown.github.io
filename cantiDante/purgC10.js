...
$(document).ready(function(){
	$("#buttonpurgC10").click(function(){
		numero=Math.floor(Math.random()*purgC10.length)
		randnopre = purgC10[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC10[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC10[numero+1];
