...
$(document).ready(function(){
	$("#buttonpurgC1").click(function(){
		numero=Math.floor(Math.random()*purgC1.length)
		randnopre = purgC1[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC1[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC1[numero+1];
