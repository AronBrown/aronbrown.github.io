...
$(document).ready(function(){
	$("#buttoninfC15").click(function(){
		numero=Math.floor(Math.random()*infC15.length)
		randnopre = infC15[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = infC15[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = infC15[numero+1];
		if (typeof(randnopost)=="undefined") {
			randnopost="..."
		}
		$('#zonaDinamicaPost').text(randnopost);
		console.log("Inferno 15");
	});
});
