...
$(document).ready(function(){
	$("#buttonpurgC6").click(function(){
		numero=Math.floor(Math.random()*purgC6.length)
		randnopre = purgC6[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC6[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC6[numero+1];
