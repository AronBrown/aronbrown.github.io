...
$(document).ready(function(){
	$("#buttonpurgC24").click(function(){
		numero=Math.floor(Math.random()*purgC24.length)
		randnopre = purgC24[numero-1];
if (typeof(randnopre)=="undefined") {
			randnopre="..."
		}
		$('#zonaDinamicaPre').text(randnopre);
		randno = purgC24[numero];
		$('#zonaDinamicaNow').text(randno);
		randnopost = purgC24[numero+1];
		if (typeof(randnopost)=="undefined") {
			randnopost="..."
		}
		$('#zonaDinamicaPost').text(randnopost);
		console.log("Purgatorio 24");
	});
});
